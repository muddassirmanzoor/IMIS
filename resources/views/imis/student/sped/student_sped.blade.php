        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitStudentsForm('Visually Impaired')">
                    ...
                    <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitStudentsForm('Hearing Impaired')">
                    ...
                    <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitStudentsForm('Slow Learners')">
                    ...
                    <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitStudentsForm('Mentally Challenged')">
                        <div class="widget-stat card bg-left-line-red  tiles-bar-tooltip-wrap">
                            <div class="card-body1">
                                <div class="media">
                                    <div class="media-body text-white">
                    ...
                    <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitStudentsForm('Physically Handicapped')">
                        <div class="widget-stat card bg-left-line-red  tiles-bar-tooltip-wrap">
                            <div class="card-body1">
                                <div class="media">
                                    <div class="media-body text-white">
									...
									<div class="col-sm-12">
										<div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">Disablity Wise Enrollment</h3>
											</div>
											<div class="card-body">
							...
							<div class="col-xl-12 col-xxl-12 col-sm-12">
								<div class="row">
									<div class="col-sm-12">
										<div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">Gender Wise And Class Wise Students</h3>
											</div>
											<div class="card-body">
