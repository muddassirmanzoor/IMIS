    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitSchoolsForm('Primary')">
                ...
                <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitSchoolsForm('Middle')">
                ...
                <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitSchoolsForm('High')">
                ...
                <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitSchoolsForm('H.Sec.')">
                ...
                <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitSchoolsForm('sMosque')">
...
{{--													<h3 class="card-header-heading">Level Wise Schools</h3>--}}
{{--												</div>--}}
{{--                                                <div class="card-body">--}}
...
{{--                                </div>--}}
                                <div class="col-md-6">
                                    <div class="widget-stat card">
										<div class="card-header">
											<h3 class="card-header-heading">Schools By Shift</h3>
										</div>
                                        <div class="card-body">
                                                <div class="media mb-3">
...
{{--                                                                {{number_format($data['db_schools']->MorningShift)}}--}}
                                ...
                                <div class="col-sm-6">
                                    <div class="card">
										<div class="card-header">
											<h3 class="card-header-heading">School By Area</h3>
										</div>
                                        <div class="card-body">
...
{{--                            @if($dropdownData['request']['school_type'] == 1)--}}
                            <!-- row START-->
                                <div class="col-md-12">
                                    <div class="card">
										<div class="card-header">
											<h3 class="card-header-heading">School Ownership</h3>
										</div>
                                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
										<div class="card-header">
											<h3 class="card-header-heading">School Construction Type</h3>
										</div>
                                        <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
										<div class="card-header">
											<h3 class="card-header-heading">School Buliding Safety</h3>
										</div>
                                        <div class="card-body">
