    ...
    <script>
        ...
        jQuery(function ($) {
            ...
            $('#Schools_Area').highcharts({
                ...
                colors: ['#8ac75f','#427ec6','#3a497f','#60c3ab'],
                title: {
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-2 col-xxl-2 col-sm-2" onclick="submitSchoolsForm('{{$program->SchoolProgram}}')">
                        <div class="widget-stat card bg-left-line-yellow tiles-bar-tooltip-wrap">
                            <div class="card-body1">
                                <div class="media">
                                    <div class="media-body text-white">
                                        <p class="mb-1 tiles-bar-title">{{$program->SchoolProgram}} </p>
                    ...
                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">Program Wise Schools Type</h3>
											</div>
                                            <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
											<div class="card-header">
														<h3 class="card-header-heading">Schools by level</h3>
													</div>
                                            <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">Gender Wise Schools</h3>
											</div>
                                            <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">Area Wise Schools</h3>
											</div>
                                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">Ownership Wise Schools</h3>
											</div>
                                            <div class="card-body">
