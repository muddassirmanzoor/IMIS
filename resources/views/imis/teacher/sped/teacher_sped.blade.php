						...
						<div class="col-xl-12 col-xxl-12 col-sm-12">
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="card">
										<div class="card-header">
											<h3 class="card-header-heading">Disability Wise Teachers</h3>
										</div>
										<div class="card-body">
											<div id="DIS"></div>
										</div>
...
{{--                                        </div>--}}
								<div class="col-sm-12">
									<table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
												<tbody>
												<tr>
													<td style="color: #ffffff; background: #1d3768; font-weight: bold;">#</td>
													<td style="color: #ffffff; background: #1d3768; font-weight: bold;">Name of Designation</td>
													<td style="color: #ffffff;background: #1d3768;font-weight: bold;">Total Number</td>
												</tr>
