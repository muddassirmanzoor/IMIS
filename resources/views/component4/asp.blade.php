...
<style>
    /***************district with on ASP Schools Color*****************/
path#Rawalpindi, path#Chakwal, path#Gujrat, path#Mandi_Bahauddin, path#Sargodha, path#Sialkot, path#Gujranwala, path#Narowal, path#Lahore, path#Faisalabad, path#Toba_Tek_Singh, path#Sahiwal, path#Khanewal, path#Multan {
    fill: #5d9649 !important;
}

path#Rawalpindi:hover, path#Chakwal:hover, path#Gujrat:hover, path#Mandi_Bahauddin:hover, path#Sargodha:hover, path#Sialkot:hover, path#Gujranwala:hover, path#Narowal:hover, path#Lahore:hover, path#Faisalabad:hover, path#Toba_Tek_Singh:hover, path#Sahiwal:hover, path#Khanewal:hover, path#Multan:hover {
        fill: #cddc39 !important;
}
</style>
@push('scripts')
    <!-- Include Js Files -->
    @include('partials.component4.highcharts_asp')
@endpush
        <!--**********************************
            Content body start
        ***********************************-->
                                ...
                                <div class="row mx-0 align-items-center">
                                    <div class="col-sm-8  mb-3">
                                        <div class="welcome-text">
                                            <h4>Afternoon School Program</h4>
                                            <p style="text-align: justify;">The Afternoon School Program aims to provide equitable educational opportunities to children in areas where access to schools remains a challenge along with low retention and high drop-out rates. The program is designed to ‘upgrade’ the existing primary or middle schools to middle or high school level respectively, thereby allowing the students to transition into higher grades within the same premises. This provides easy access to the students and results in an increase in retention. It has resulted in a highly cost effective solution and is currently ongoing in 577 schools across 22 districts in Punjab, so far enrolling over 20,000 children. Given the promising outcome, the Government of Punjab plans to scale-up this initiative to the remaining 14 districts as well.</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4  mb-3">
                                        <div class="welcome-text">
                                            <img src="{{ asset('images/imis-images/Insaaf-Afternoon-School-Program.jpg') }}" style="width: 100%;height: auto;">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body1">
                                                <div class="media">
                                                    <div class="media-body text-white">
                                                        <p class="mb-1 tiles-bar-title">SCHOOLS</p>
                                                        <h3 class="tiles-bar-value">{{number_format(1500)}}<span class="target-value-types"><span class="target-color">Target<br> {{number_format(800)}}</span> <span class="trained-color">Achieved<br> {{number_format(1500)}}</span></span>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-2 col-xxl-2 col-sm-2">
                                        <div class="widget-stat card bg-left-line-yellow">
                                            <div class="card-body1">
                                                <div class="media">
                                                    <div class="media-body text-white">
                                                        <p class="mb-1 tiles-bar-title">Enrollment</p>
                                                        <h3 class="tiles-bar-value">{{number_format(92072)}}<span class="gender-schools-types"> <span class="female-color"><i class="fa fa-female" aria-hidden="true"></i><br> {{number_format(57102)}}</span><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> {{number_format(34970)}}</span></span>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                   ...
                                   <!-- <div class="col-xl-2 col-xxl-2 col-sm-2">
                                        <div class="widget-stat card bg-left-line-green">
                                            <div class="card-body1">
                                                <div class="media">
                                                    <div class="media-body text-white">
                                                        <p class="mb-1 tiles-bar-title">OOSC Enrollment</p>
                                                        <h3 class="tiles-bar-value">30,240<span class="gender-schools-types"><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> 16,800</span> <span class="female-color"><i class="fa fa-male" aria-hidden="true"></i><br> 13,440</span></span>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body1">
                                                <div class="media">
                                                    <div class="media-body text-white">
                                                        ...
                                                        <h3 class="tiles-bar-value">{{number_format(5218)}}<span class="target-value-types"><span class="target-color">Target<br> {{number_format(3864)}}</span> <span class="trained-color">Achieved<br> {{number_format(5218)}}</span></span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!--<div class="col-xl-2 col-xxl-2 col-sm-2">
                                        <div class="widget-stat card bg-left-line-red">
                                            <div class="card-body1">
                                                <div class="media">
                                                    <div class="media-body text-white">
                                                        <p class="mb-1 tiles-bar-title">Trained Teachers</p>
                                                        <h3 class="tiles-bar-value">3,864  <span class="target-value-types"><span class="target-color">Target<br> 3,864</span> <span class="trained-color">Trained<br> 3,864</span></span>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div id="external-events" class="districts-asp my-3">
                                                            <div class="external-event ui-draggable ui-draggable-handle districts-asp-label" data-class="bg-aps" style="position: relative;"><i class="fa fa-move"></i>14 Districts With ASP Schools</div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-xl-6 col-xxl-6 col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div id="districts_schools_count" style="min-width: 100%; height: 320px; margin: 15 auto"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div id="districts_students_count" style="min-width: 100%; height: 320px; margin: 15 auto"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
{{--                                                <div class="card">--}}
{{--                                                    <div class="card-body">--}}
{{--                                                        <div id="district_class_enrollment" style="min-width: 100%; height: auto; margin: 15 auto"></div>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
                                            ...
                                            <div class="col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div id="fund_allocation" style="min-width: 100%; height: 320px; margin: 15 auto"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div id="enrollment_class" style="min-width: 100%; height: 320px; margin: 15 auto"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        ***********************************-->
        ...
        <!-- State Modal Start -->
        <div class="modal bd-example-modal-lg" id="Rawalpindi-details1" tabindex="-1" role="dialog" aria-labelledby="VehariModalLabel" aria-hidden="true">
