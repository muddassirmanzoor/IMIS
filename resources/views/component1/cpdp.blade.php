...
@section('title', 'CPDP- Continuous Professional Development Programme')
...
@section('content')
    ...
    <style>
        ...
        #state_Rawalpindi:hover + .district-details {
            opacity: 1;
            visibility: visible;
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <div class="component-content-wrapper">
                                        <h4 class="sub-component-title">Continuous Professional Development Programme (CPDP)</h4>
                                        <p>Improved Classroom Teaching and Learning at Primary level through CPD and Mentoring:</p>
                                        <ol>
                                            <li>Development, availability, and utilization of online Learning Management System and digital CPD modules by primary school teachers.</li>
                                            <li> Cumulative number of AEOs trained and providing support to Primary Schools in classroom teaching and learning.</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body1">
                                            <div class="media">
                                                <div class="media-body text-white">
                                                    <p class="mb-1 tiles-bar-title">Primary Schools</p>
                                                    <h3 class="tiles-bar-value">32,356 <span class="gender-schools-types"> <span class="female-color"><i class="fa fa-female" aria-hidden="true"></i><br> 16,925 </span><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> 15,431 </span></span>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-2 col-xxl-2 col-sm-2">
                                    <div class="widget-stat card bg-left-line-yellow tiles-bar-tooltip-wrap">
                                        <div class="card-body1">
                                            <div class="media">
                                                <div class="media-body text-white">
                                                    <p class="mb-1 tiles-bar-title">Total No. Of PST</p>
                                                    <h3 class="tiles-bar-value">179,417<span class="gender-schools-types"><span class="female-color"><i class="fa fa-female" aria-hidden="true"></i><br> NA</span><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> NA</span> </span>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-2 col-xxl-2 col-sm-2">
                                    <div class="widget-stat card bg-left-line-red  tiles-bar-tooltip-wrap">
                                        <div class="card-body1">
                                            <div class="media">
                                                <div class="media-body text-white">
                                                    <p class="mb-1 tiles-bar-title">Trained AEOs</p>
                                                    <h3 class="tiles-bar-value">3,181  <span class="target-value-types"><span class="target-color">Target<br> 3,200</span> <span class="trained-color">Trained<br> 3,181</span></span>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body1">
                                            <div class="media">
                                                <div class="media-body text-white">
                                                    ...
                                                    <h3 class="tiles-bar-value">125,591<span class="target-value-types"><span class="target-color">Target<br> 179,417</span> <span class="trained-color">Trained<br> 125,591</span></span>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-2 col-xxl-2 col-sm-2">
                                    <div class="widget-stat card bg-left-line-red  tiles-bar-tooltip-wrap">
                                        <div class="card-body1">
                                            <div class="media">
                                                <div class="media-body text-white">
                                                    <p class="mb-1 tiles-bar-title">Tablets </p>
                                                    <h3 class="tiles-bar-value">32,356  <span class="gender-schools-types"><span class="target-color">Target<br>32,356</span> <span class="distributed-color">Distributed<br> 0</span></span>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-xxl-6 col-sm-6">
                                    <div class="card">
										<div class="card-header">
											<h3 class="card-header-heading">All Districts of Punjab</h3>
										</div>
                                        <!--<div class="card-header">
                                            <div id="external-events" class="districts-asp my-3">
                                                <div class="external-event ui-draggable ui-draggable-handle districts-asp-label" data-class="bg-aps" style="position: relative;"><i class="fa fa-move"></i>All districts of punjab</div>
                                            </div>
                                            <div id="external-events" class="districts-asp my-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-xxl-12 col-sm-12">
                                            <table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
                                                <tbody>
                                                <tr>
                                                    <td rowspan="2" colspan="1"  style="color: #ffffff; background: repeating-linear-gradient(180deg, #1d3768, transparent 195px); font-weight: bold;">Modules Name</td>
													<td colspan="2" style="color: #ffffff;background: #8faf6a;font-weight: bold;">AEOs </td>
                                                    <td colspan="2" style="color: #ffffff;background: #cd7291; font-weight: bold;">Teachers </td>
                                                </tr>
                                                <tr>
                                                    <th  style=" background: #8faf6a96;">Targets</th>
                                                    <th  style=" background: #8faf6a96;">Trained</th>
                                                    <th  style=" background: #cd729196;">Targets</th>
                                                    <th  style=" background: #cd729196;">Trained</th>
                                                </tr>
                                                <tr>
                                                    <th>Basic</th>
                                                    <th>3181</th>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-xxl-12 col-sm-12 mt-5">
                                    <div class="card">
										<div class="card-header">
											<h3 class="card-header-heading">Year Wise Teacher Trained</h3>
										</div>
                                        <div class="card-body">
                                            <div id="year_wise_teacher_trends"></div>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- row END -->
...
{{--                                        </div>--}}
{{--                                        <div class="card-body">--}}
{{--                                            <div id="Tablet_Distribution"></div>--}}
{{--                                        </div>--}}
                                    </div>
                                </div>
                            </div>
...
{{--                                    <div class="card">--}}
{{--                                        <div class="card-header">--}}
{{--                                            <h4 class="card-title">AEOs Visit Report </h4>--}}
{{--                                        </div>--}}
{{--                                        <div class="card-body">--}}
...
{{--                                                        <td>abc</td>--}}
{{--                                                        <td>abc</td>--}}
{{--                                                        <td><span class="badge badge-danger">Bad</span>--}}
{{--                                                        </td>--}}
{{--                                                    </tr>--}}
{{--                                                    <tr>--}}
{{--                                                        <td>abc</td>--}}
...
{{--                                                        <td>abc</td>--}}
{{--                                                        <td>abc</td>--}}
{{--                                                        <td><span class="badge badge-info">Not Good</span>--}}
{{--                                                        </td>--}}
{{--                                                    </tr>--}}
{{--                                                    <tr>--}}
{{--                                                        <td>abc</td>--}}
...
{{--                                                        <td>abc</td>--}}
{{--                                                        <td>abc</td>--}}
{{--                                                        <td><span class="badge badge-success">Good</span>--}}
{{--                                                        </td>--}}
{{--                                                    </tr>--}}
                        ...
                        <div class="col-xl-12 col-xxl-12 col-sm-12">
                            <table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
                                ...
                                <tr style="color: #ffffff; background: #7195cf; font-weight: bold;">
                                    ...
                                    <td>No. of Teblets Distributed</td>
                                </tr>
                                <tr>
                                    <th>Rawalpindi </th>
                                    <th>200</th>
...
<!-- State Modal  END -->
        ...
        @push('scripts')
            <!-- Include Js Files -->
            @include('partials.component1.highcharts1')
        @endpush
@endsection
