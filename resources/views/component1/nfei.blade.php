...
path#Muzaffargarh,path#Rajanpur,path#Bahawalpur,path#Rahimyar_Khan,path#Dera_Ghazi_Khan{
    fill: #5d9649 !important;
}

path#Muzaffargarh:hover,path#Rajanpur:hover,path#Bahawalpur:hover,path#Rahimyar_Khan:hover,path#Dera_Ghazi_Khan:hover {
                            ...
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <div class="component-content-wrapper">
										<h4 class="sub-component-title">Utilizing the Potential of Non-Formal Sector (NFEIs by LNFBD)</h4>
										<p>Enhanced access to primary level education for the most marginalized and disadvantaged children, especially girls in remote areas through institutionalized Accelerated Education Program (AEP)</p>
									</div>
								</div>
							</div>
                                    ...
                                    <div class="card-body1">
                                        <div class="media">
                                            <div class="media-body text-white">
												...
												<h3 class="tiles-bar-value">
{{--                                                    {{number_format($data['total_data']['TotalNEFI'])}} --}}
                                                    {{number_format(1000)}}
                                                    <span class="target-value-types"><span class="target-color">Target<br> 1,000 </span>
                                                        <span class="trained-color">Achieved<br>
{{--                                                            {{number_format($data['total_data']['TotalNEFI'])}}--}}
                                                            {{number_format(1000)}}
                                                        </span></span>
                                                    </h3>
                            ...
                            <div class="col-xl-2 col-xxl-2 col-sm-2">
                                <div class="widget-stat card bg-left-line-green tiles-bar-tooltip-wrap">
                                    <div class="card-body1">
                                        <div class="media">
                                            <div class="media-body text-white">
                                                <p class="mb-1 tiles-bar-title">Enrolled Students </p>
												<h3 class="tiles-bar-value">
{{--                                                    {{number_format($data['total_data']['TotalEnrollment'])}} --}}
                                                    {{number_format(33925)}}
                                                    <span class="target-value-types"><span class="target-color">Target<br> 40,000</span>
                                                        <span class="trained-color">Achieved<br>
{{--                                                            {{number_format($data['total_data']['TotalEnrollment'])}}--}}
                                                            {{number_format(33925)}}
                                                        </span></span>
...
{{--													<h3 class="tiles-bar-value">1,000 <span class="gender-schools-types"><span class="female-color"><i class="fa fa-female" aria-hidden="true"></i><br> 300 </span><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> 700 </span> </span>--}}
{{--                                    </h3>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
                            ...
                            <!--<div class="col-xl-2 col-xxl-2 col-sm-2">
                                <div class="widget-stat card bg-left-line-yellow tiles-bar-tooltip-wrap">
                                    <div class="card-body1">
                                        <div class="media">
                                            <div class="media-body text-white">
                                                <p class="mb-1 tiles-bar-title">Total NFEIs Functional &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                            ...
                            <div class="col-xl-2 col-xxl-2 col-sm-2">
                                <div class="widget-stat card bg-left-line-purple tiles-bar-tooltip-wrap">
                                    <div class="card-body1">
                                        <div class="media">
                                            <div class="media-body text-white">
                                                <p class="mb-1 tiles-bar-title">Master trainers Trained</p>
                                                <h3 class="tiles-bar-value">36<span class="gender-schools-types"><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> 40%</span> <span class="female-color"><i class="fa fa-male" aria-hidden="true"></i><br> 60%</span></span>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-2 col-xxl-2 col-sm-2">
                                <div class="widget-stat card bg-left-line-lgreen tiles-bar-tooltip-wrap">
                                    <div class="card-body1">
                                        <div class="media">
                                            <div class="media-body text-white">
                                                <p class="mb-1 tiles-bar-title">Literacy Mobilizers &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                <h3 class="tiles-bar-value">14 <span class="gender-schools-types"><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> 7</span> <span class="female-color"><i class="fa fa-male" aria-hidden="true"></i><br> 7</span></span>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-2 col-xxl-2 col-sm-2">
                                <div class="widget-stat card bg-left-line-red  tiles-bar-tooltip-wrap">
                                    <div class="card-body1">
                                        <div class="media">
                                            <div class="media-body text-white">
                                                <p class="mb-1 tiles-bar-title">OOSC Enrolled</p>
                                                <h3 class="tiles-bar-value">40,000  <span class="gender-schools-types"><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br> 20,000 </span> <span class="female-color"><i class="fa fa-male" aria-hidden="true"></i><br> 20,000 </span></span>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">District Wise NFEIs</h3>
											</div>
                                            <div class="card-body">
                                                <div id="functional_nonfunctional" style="height: 280px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="card">
											<div class="card-header">
												<h3 class="card-header-heading">District And Age Wise Enrollment</h3>
											</div>
                                            <div class="card-body">
                                                <div id="district_age_enrollment_graph"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal bd-example-modal-lg" id="{{$key}}-details1" tabindex="-1" role="dialog" aria-labelledby="{{$key}}ModalLabel" aria-hidden="true">
                    ...
                    <div class="col-xl-12 col-xxl-12 col-sm-12">
                        <table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
                            ...
                            <tr>
                                ...
                                <td rowspan="2" colspan="1" style="color: #ffffff; background: #7195cf; font-weight: bold;" >NFEI's</td>
								<td colspan="2" style="color: #ffffff;background: #8faf6a;font-weight: bold;">Teachers</td>
                            ...
                            <tr>
                                <th>{{$tehsil['Tehsil']}}</th>
                                <th>{{$tehsil['TotalNEFI']}}</th>
                                <th>{{$tehsil['FemaleTeachers']}}</th>
                                <th>{{$tehsil['MaleTeachers']}}</th>
								<th>{{$tehsil['FemaleStudents']}}</th>
                                <th>{{$tehsil['MaleStudents']}}</th>
...
@push('scripts')
    <!-- Include Js Files -->
    @include('partials.component1.highcharts3')
@endpush
@endsection
