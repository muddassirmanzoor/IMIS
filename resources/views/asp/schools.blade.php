    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="row page-titles mx-0">
                <div class="col-sm-7">
                    <div class="welcome-text">
                        <h4 style="color: #2ea762;">Improving Access and Learning at Middle Level</h4>
                    </div>
                </div>
                <div class="col-sm-5 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Component 4</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">ASP</a></li>
                    </ol>
                </div>
            </div>
            <div class="row page-titles mx-0 align-items-center">
                <div class="col-sm-8">
                    <div class="welcome-text">
                        <h2 style="color: #2ea762;">Afternoon School Program</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-xxl-3 col-sm-3">
                    <div class="widget-stat card bg-left-line-green tiles-bar-tooltip-wrap">
                        <div class="card-body">
                            <div class="media">
                                <img src="{{ asset('images/imis-images/school.svg') }}" style="width: 60px;height: auto;">
                                <div class="media-body text-white">
                                    <p class="mb-1 tiles-bar-title">Schools</p>
                                    <h3 class="tiles-bar-value">{{$data['count_data']->TotalSchools}}</h3>
                                </div>
                            </div>
                        </div>
                        <!----------tooltip-content start----------->
                        <div class="tiles-bar-content tiles-bar-tooltip-content ts-tooltip-content">
                            <div class="row align-items-center">
                                <div class="col-xl-12 col-xxl-12 col-sm-12">
                                    <figure class="highcharts-figure">
                                        <div id="total_schools" style="min-width: 250px; height: 250px; margin: 15 auto"></div>
                                    </figure>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-3">
                    <div class="widget-stat card bg-left-line-red tiles-bar-tooltip-wrap">
                        <div class="card-body">
                            <div class="media">
                                <img src="{{ asset('images/imis-images/ENROLLED.svg') }}" style="width: 60px;height: auto;">
                                <div class="media-body text-white">
                                    <p class="mb-1 tiles-bar-title">Enrollment</p>
                                    <h3 class="tiles-bar-value">{{$data['count_data']->TotalStudents}}</h3>
                                </div>
                            </div>
                        </div>
                        <!----------tooltip-content start----------->
                        <div class="tiles-bar-content tiles-bar-tooltip-content te-tooltip-content">
                            <div class="row align-items-center">
                                <div class="col-xl-12 col-xxl-12 col-sm-12">
                                    <figure class="highcharts-figure">
                                        <div id="enrollment_chart" style="min-width: 250px; height: 250px; margin: 15 auto"></div>
                                    </figure>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-xxl-3 col-sm-3">
                    <div class="widget-stat card bg-left-line-blue tiles-bar-tooltip-wrap">
                        <div class="card-body">
                            <div class="media">
                                <img src="{{ asset('images/imis-images/teachers.svg') }}" style="width: 60px;height: auto;">
                                <div class="media-body text-white">
                                    <p class="mb-1 tiles-bar-title">Teachers</p>
                                    <h3 class="tiles-bar-value">{{$data['count_data']->TotalTeachers}}</h3>
                                </div>
                            </div>
                        </div>
                        <!----------tooltip-content start----------->
                        <div class="tiles-bar-content tiles-bar-tooltip-content ttech-tooltip-content">
                            <div class="row align-items-center">
                                <div class="col-xl-12 col-xxl-12 col-sm-12">
                                    <!--<div id="external-events" class="my-3">
                                        <div class="gender-info-label"><img src="images/imis-images/teachers.svg"> Total Teachers : 2858</div>
                                    ...
                                    <figure class="highcharts-figure">
                                        <div id="Teachers_chart" style="min-width: 250px; height: 250px; margin: 15 auto"></div>
                                    </figure>
                                </div>
                            </div>
                        </div>
...
{{--                        <div class="card-body">--}}
{{--                            <div class="media">--}}
{{--                                <img src="{{ asset('images/imis-images/trained.svg') }}" style="width: 60px;height: auto;">--}}
{{--                                <div class="media-body text-white">--}}
{{--                                    <p class="mb-1 tiles-bar-title">Trained Teachers</p>--}}
{{--                                    <h3 class="tiles-bar-value">2858</h3>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <!----------tooltip-content start----------->--}}
{{--                        <div class="tiles-bar-content tiles-bar-tooltip-content tt-tooltip-content">--}}
{{--                            <div class="row align-items-center">--}}
{{--                                <div class="col-xl-12 col-xxl-12 col-sm-12">--}}
{{--                                    <figure class="highcharts-figure">--}}
{{--                                        <div id="trained_teachers" style="min-width: 250px; height: 250px; margin: 15 auto"></div>--}}
{{--                                    </figure>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div id="external-events" class="districts-asp my-3">
                                        <div class="external-event ui-draggable ui-draggable-handle districts-asp-label" data-class="bg-aps" style="position: relative;"><i class="fa fa-move"></i>14 Districts With No. ASP Schools</div>
                                    </div>
                                    <div id="external-events" class="districts-asp my-3">
...
{{--                                </div>--}}
{{--                                <div class="card-body">--}}
{{--                                    <div id="year_enrollment" style="min-width: 100%; height: auto; margin: 15 auto"></div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
    ...
    <!-- row END -->
    <!-- State Modal Start -->
    @include('partials.asp.modal');
    @push('scripts')
        <!-- Include School Js Files -->
        @include('partials.asp.highcharts')
    @endpush
@endsection
