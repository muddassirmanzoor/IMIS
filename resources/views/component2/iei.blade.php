...
@section('title', 'Inclusive Education Initiative of SED')

@section('content')
<!---Map CSS Start---->
<style>
path#Jhelum,path#Multan{
    fill: #5d9649 !important;
}

path#Jhelum:hover,path#Multan:hover {
 ...
 <link href="https://cdn.datatables.net/1.13.6/css/jquery.dataTables.min.css" rel="stylesheet">
	<script>
		jQuery(function ($) {
			...
			/***********District Wise PSTs Trained Against Targets************/
			$('#district_accessible_infrastructure').highcharts({
				chart: {
				type: 'column'
				},
				title: {
					text: 'Accessible Infrastructure',
					align: 'left'
				},
				xAxis: {
					categories: ['Jhelum', 'Multan']
				},
				yAxis: {
					title: {
							...
							<div class="row">
								<div class="col-sm-12 mb-3">
									<div class="component-content-wrapper">
										<h4 class="sub-component-title">Inclusive Education Initiative of SED</h4>
										<p>Children with mild cognitive and physical disabilities have improved access to mainstream schools through inclusive learning environment and provision of assistive devices.</p>
									</div>
								</div>
							</div>
							<!---------------Component Short Details--------------->
										...
										<div class="card-body1">
											<div class="media">
												<div class="media-body text-white">
													<p class="mb-1 tiles-bar-title">SCHOOLS Screened</p><br>
													<h3 class="tiles-bar-value">{{ $count_card[0]->total_screened_schools }}<span class="gender-schools-types"> <span class="female-color"><i class="fa fa-female" aria-hidden="true"></i><br> {{$count_card[0]->screened_female_schools}} </span><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br>{{$count_card[0]->screened_male_schools}} </span></span>
													</h3>
												</div>
											</div>
										</div>
								...
								<!--<div class="col-xl-2 col-xxl-2 col-sm-2">
									<div class="widget-stat card bg-left-line-purple tiles-bar-tooltip-wrap">
										<div class="card-body1">
											<div class="media">
												<div class="media-body text-white">
													<p class="mb-1 tiles-bar-title">TEACHERS Trained</p><br>
													<h3 class="tiles-bar-value">48207<span class="gender-schools-types"><span class="male-color">Target<br> 24103</span> <span class="female-color">Achieved<br> 24104</span></span>
													</h3>
												</div>
											</div>
										</div>
								...
								<div class="col-xl-2 col-xxl-2 col-sm-2">
									<div class="widget-stat card bg-left-line-yellow tiles-bar-tooltip-wrap">
										<div class="card-body1">
											<div class="media">
												<div class="media-body text-white">
													<p class="mb-1 tiles-bar-title">Students Screened</p><br>
													<h3 class="tiles-bar-value">{{$count_card[0]->screened_total_students}}<span class="gender-schools-types"><span class="male-color"><i class="fa fa-male" aria-hidden="true"></i><br>{{$count_card[0]->screened_male_students}}</span> <span class="female-color"><i class="fa fa-male" aria-hidden="true"></i><br>{{$count_card[0]->screened_female_students}}</span></span>
													</h3>
												</div>
											</div>
										</div>
...
{{--											<div class="media">--}}
{{--												<div class="media-body text-white">--}}
{{--													<p class="mb-1 tiles-bar-title">Mild disabilities </p><br>--}}
{{--													<h3 class="tiles-bar-value">3,200  <span class="target-value-types"><span class="target-color">Target<br> 16,191</span> <span class="trained-color">Achieved<br> 16,192</span></span>--}}
{{--													</h3>--}}
{{--												</div>--}}
{{--											</div>--}}
{{--										</div>--}}
...
{{--											<div class="media">--}}
{{--												<div class="media-body text-white">--}}
{{--													<p class="mb-1 tiles-bar-title">Assistive Devices</p><br>--}}
{{--													<h3 class="tiles-bar-value">48240  <span class="target-value-types"><span class="target-color">Target<br>24120</span> <span class="distributed-color">Distributed<br> 24120</span></span>--}}
{{--													</h3>--}}
{{--												</div>--}}
{{--											</div>--}}
{{--										</div>--}}
								...
								<div class="col-xl-2 col-xxl-2 col-sm-2">
									<div class="widget-stat card bg-left-line-red  tiles-bar-tooltip-wrap">
										<div class="card-body1">
											<div class="media">
												<div class="media-body text-white">
													<p class="mb-1 tiles-bar-title">Accessible Infrastructure </p>
													<h3 class="tiles-bar-value">1053  <span class="target-value-types"><span class="target-color">Target<br>1053</span> <span class="trained-color">Achieved<br> 1053</span></span>
													</h3>
												</div>
											</div>
										</div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div id="external-events" class="districts-asp my-3">
                                            <div class="external-event ui-draggable ui-draggable-handle districts-asp-label" data-class="bg-aps" style="position: relative;"><i class="fa fa-move"></i>Districts With Highest Disability Prevalence</div>
                                        </div>
                                    </div>
								...
								<div class="col-xl-6 col-xxl-6 col-sm-6">
									<div class="table-responsive">
										<table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
											<tbody>
												<tr>
													<td rowspan="2" colspan="1" style="color: #ffffff; background: repeating-linear-gradient(180deg, #1d3768, transparent 195px); font-weight: bold;">Districts</td>
													<td colspan="2" style="color: #ffffff; background: #7195cf; font-weight: bold;">Stand Alone Primary</td>
													<td colspan="2" style="color: #ffffff;background: #8faf6a;font-weight: bold;">Primary Sections in (Middle,Sec,H.Sec)</td>
												</tr>
												<tr>
													<th style=" background: #89a4d096;">Schools</th>
													<th style=" background: #89a4d096;">Enrollment</th>
													<th style=" background: #8faf6a96;">Schools </th>
													<th style=" background: #8faf6a96;">Enrollment </th>
												</tr>
												@foreach($screen_stat_table as $stat)

												<tr>
													<th>{{ $stat->d_name}}</th>
													<th>{{ $stat->primary_schools_count }}</th>
													<th>{{ $stat->primary_students_count }}</th>
													<th>{{ $stat->other_schools_count }}</th>
													<th>{{ $stat->other_students_count }}</th>
												</tr>
												@endforeach
									...
									<h3>Phase-I (Screening)</h3>
									<div class="table-responsive">
										<table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
											<tbody>
												<tr>
													<td rowspan="2" colspan="1" style="color: #ffffff; background: repeating-linear-gradient(180deg, #1d3768, transparent 195px); font-weight: bold;">Districts</td>
													<td colspan="2" style="color: #ffffff; background: #8faf6a; font-weight: bold;">Screening</td>
													<td colspan="1" style="color: #ffffff;background: #9E9E9E;font-weight: bold;">Referred for Special Screening</td>
												</tr>
												<tr>
													<th style=" background: #8faf6a96;">Targets</th>
													<th style=" background: #8faf6a96;">Screened</th>
													<th style=" background: #9e9e9e96;">Numbers </th>
												</tr>
												<tr>
													<th>Jhelum</th>
													<th>66850</th>
									...
									<h3>Phase-II (Specialized Screening)</h3>
									<div class="table-responsive">
										<table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
											<tbody>
												<tr>
													<td rowspan="2" colspan="1" style="color: #ffffff; background: repeating-linear-gradient(180deg, #1d3768, transparent 195px); font-weight: bold;">Districts</td>
													<td colspan="2" style="color: #ffffff; background: #9E9E9E; font-weight: bold;">Screening</td>
													<td colspan="3" style="color: #ffffff;background: #ffbc00;font-weight: bold;">Disability</td>
												</tr>
												<tr>
													<th style=" background: #9e9e9e96;">Targets</th>
													<th style=" background: #9e9e9e96;">Screened</th>
													<th style=" background: #f5d26f;">Vision </th>
													<th style=" background: #f5d26f;">Hearing </th>
													<th style=" background: #f5d26f;">Walking </th>
												</tr>
												<tr>
													<th>Jhelum</th>
													<th>3323</th>
...
{{--									<h3>Assistive Devices Distribution</h3>--}}
{{--									<div class="table-responsive">--}}
{{--										<table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">--}}
{{--											<tbody>--}}
{{--												<tr>--}}
{{--													<td rowspan="2" colspan="1" style="color: #ffffff; background: repeating-linear-gradient(180deg, #1d3768, transparent 195px); font-weight: bold;">Districts</td>--}}
{{--													<td colspan="3" style="color: #ffffff; background: #ffbc00; font-weight: bold;">Required</td>--}}
{{--													<td colspan="3" style="color: #ffffff;background: #93a8bd;font-weight: bold;">Provision </td>--}}
{{--												</tr>--}}
{{--												<tr>--}}
{{--													<th style=" background: #f5d26f;">Glasses</th>--}}
{{--													<th style=" background: #f5d26f;">Hearing Aids </th>--}}
{{--													<th style=" background: #f5d26f;">Wheel Chairs / Crutches </th>--}}
{{--													<th style=" background: #bfd1e4;">Glasses</th>--}}
{{--													<th style=" background: #bfd1e4;">Hearing Aids </th>--}}
{{--													<th style=" background: #bfd1e4;">Wheel Chairs / Crutches </th>--}}
{{--												</tr>--}}
{{--												<tr>--}}
{{--													<th>Jhelum</th>--}}
{{--													<th>150</th>--}}
...
{{--									</div>--}}
							...
							<div class="row">
								<div class="col-xl-12 col-xxl-12 col-sm-12 my-4">
									<div id="district_accessible_infrastructure"></div>
								</div>
							</div><!-- row END -->
							<!--------MAP – Component 1.1  End--------->
                            </div>
                        </div>
                    </div>
				</div>
        ...
        ***********************************-->
<!-- State Modal Start -->
<div class="modal" id="Jhelum-details1" tabindex="-1" role="dialog" aria-labelledby="TobaTekSinghModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><strong>Jhelum</strong></h4>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-12 col-xxl-12 col-sm-12">
						<table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
							<tbody>
								<tr>
									<td rowspan="2" style="color: #ffffff; background: repeating-linear-gradient(180deg, #1d3768, transparent 195px); font-weight: bold;">Tehsil</td>
									<td  rowspan="2"  style="color: #ffffff; background: #7195cf; font-weight: bold;">Schools</td>
									<td colspan="2" style="color: #ffffff; background: #cd7291; font-weight: bold;">Students</td>
									<td colspan="3" style="color: #ffffff;background: #93a8bd;font-weight: bold;">Provision </td>
								</tr>
								<tr>
...
<div class="modal" id="Multan-details1" tabindex="-1" role="dialog" aria-labelledby="TobaTekSinghModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><strong>Multan </strong></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
