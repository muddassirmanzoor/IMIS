...
<style>
 ...
 <link href="https://cdn.datatables.net/1.13.6/css/jquery.dataTables.min.css" rel="stylesheet">
	...
	$('#District_SPED_Female').highcharts({

		chart: {
        type: 'column'
			},
			title: {
							text: 'Enrollment by Disability',
							align: 'left'
						},

			xAxis: {
				categories: ["Hearing Impaired","Visually Impaired","Physically Handicapped","Mentally Challenged","Slow Learners"]
			},
			...
			series: [{
				name: 'Boys',
				data: [13231, 1820, 2191,5581, 2019],
				stack: 'Schools',
				color:"#3F51B5"
			},{
				name: 'Girls',
				data: [8852, 8852, 1029,754, 2220],
				stack: 'Schools',
				color:"#fa8ab0"
			}]
		});
		// $('#District_SPED_Male').highcharts({
        //
		// 		chart: {
		// 		type: 'column'
		// 	},
		// 	title: {
		// 					text: 'District Wise Special Education Male Schools ',
		// 					align: 'left'
		// 				},
        //
		// 	xAxis: {
        ...
        //
		// 	series: [{
		// 		name: 'Male Schools Screened',
		// 		data: [148, 133, 124,148, 133, 124,148, 133, 124,148, 133, 124,148, 133, 124,148, 133, 124,148, 133, 124,148, 133, 124,148, 133, 124],
		// 		stack: 'Schools',
		// 		color:"#78a3e7"
		// 	},{
		// 		name: 'Male Schools',
		...
		// });
		/************************************** */
		// $('#District_SPED_Students').highcharts({
		// 	chart: {
		...
		// 	},
		// 	title: {
		// 		text: 'No. of children screened in special education schools',
		// 		align: 'left'
		// 	},
		// 	tooltip: {
		...
		// 		name: 'Students',
		// 		data: [
		// 			{ name: 'Female', y: 73.24,color:'#E91E63' },
		// 			{ name: 'Male', y: 12.93 , color:'#3F51B5'},
		// 			{ name: 'Other', y: 4.73, color:'#ffbc00' }
		// 		]
		// 	}]
		// });
	/***********District Wise PSTs Trained Against Targets************/
		...
		/***************************************/
		// $('#moderate_disabilities').highcharts({
        //
		// 		chart: {
		// 		type: 'column'
		// 	},
		// 	title: {
		// 			text: '3.	District wise no. of children identified with moderate to severe disabilities ',
		// 			align: 'left'
		// 		},
        //
		// 	xAxis: {
		...
		/************************************** */
			...
			// 	},
			// 	title: {
			// 			text: 'District wise Provided Assistive Devices ',
			// 			align: 'left'
			// 		},
            //
			// 	xAxis: {
...
{{--				</div>--}}
				...
				<div class="row">
                    <div class="col-md-12">
                        <div class="card">
							...
							<div class="row">
								<div class="col-sm-12 mb-3">
									<div class="component-content-wrapper">
										<h4 class="sub-component-title">Provision of Assistive Devices for Children with Disabilities by SPED</h4>
										...
										<div class="card-body1">
											<div class="media">
												<div class="media-body text-white">
													...
													<h3 class="tiles-bar-value">39,226<span class="gender-schools-types"><span class="male-color">Target<br> 39,226</span> <span class="female-color">Achieved<br> 39,226</span></span>
													</h3>
												</div>
											</div>
										</div>
								...
								<div class="col-xl-2 col-xxl-2 col-sm-2">
									<div class="widget-stat card bg-left-line-yellow tiles-bar-tooltip-wrap">
										<div class="card-body1">
											<div class="media">
												<div class="media-body text-white">
													<p class="mb-1 tiles-bar-title">Recommended Devices </p>
													<h3 class="tiles-bar-value">25,325
													</h3>
												</div>
											</div>
										</div>
								...
								<div class="col-xl-2 col-xxl-2 col-sm-2">
									<div class="widget-stat card bg-left-line-red  tiles-bar-tooltip-wrap">
										<div class="card-body1">
											<div class="media">
												<div class="media-body text-white">
													<p class="mb-1 tiles-bar-title">Provided Devices</p>
													<h3 class="tiles-bar-value">693  <span class="gender-schools-types"><span class="male-color">Target<br> 25,325</span> <span class="female-color">Achieved<br> 693</span></span>
													</h3>
												</div>
											</div>
										</div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div id="external-events" class="districts-asp my-3">
                                            <div class="external-event ui-draggable ui-draggable-handle districts-asp-label" data-class="bg-aps" style="position: relative;"><i class="fa fa-move"></i>Health Screening Districts of Punjab</div>
                                        </div>
                                    </div>
							...
							<div class="col-xl-6 col-xxl-6 col-sm-6">
								<div class="row">
									<div class="col-xl-12 col-xxl-12 col-sm-12 my-4">
										<div id="District_SPED_Female"></div>
									</div>
									<div class="col-xl-12 col-xxl-12 col-sm-12 my-4">
										<div id="District_SPED_Male"></div>
									</div>
								</div><!-- row END -->
							</div>
						</div><!-- row END -->
							...
							<div class="row">
								<div class="col-xl-6 col-xxl-6 col-sm-6 my-4">
									<div id="District_SPED_Students"></div>
								</div>
								<div class="col-xl-6 col-xxl-6 col-sm-6 my-4">
									<div id="moderate_disabilities"></div>
								</div>
								<div class="col-xl-12 col-xxl-12 col-sm-12 my-4">
        ...
        ***********************************-->
				<!-- State Modal Start -->
<div class="modal bd-example-modal-lg" id="Jhelum-details1" tabindex="-1" role="dialog" aria-labelledby="VehariModalLabel" aria-hidden="true">
						...
						<table class="table table-striped table-bordered table-hover table-highlight table-checkable sanctioned-post-quota-table str_table">
							<tbody>
								<tr style="color: #ffffff; background: #7195cf; font-weight: bold;">
									...
									<td>Moderate to Severe Disabilities </td>
									<td>Provided Assistive Devices </td>
								</tr>
								<tr>
									<th>Jhelum</th>
									<th>Jhelum</th>
